...
class SSD(nn.Module):
    ...
    added multibox conv layers. Each multibox layer branches into
        ...
        2) conv2d for localization predications
        3) associated priorbox layer to produce default bounding
           boxes specific to the layer's feature map size

    args:
        phase: "test" or "train"
        base: VGG16 layers for input size of eigher 300 or 500
    ...
    def forward(self, x):
        """Applies netword layers and ops on input image(s) x
        ...
        loc = torch.cat([o.view(o.size(0), -1) for 0 in loc], 1)
    ...
    for v in cfg:
        if v == 'M':
            ...
            if batch_norm:
                ...
                layers += [conv2d, nnReLU(inplace=True)]
            in_channels = v
